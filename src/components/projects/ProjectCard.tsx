          ...
          <div className="flex flex-wrap gap-3 mt-4">
            {project.githubUrl && (
              <a
                ...
                className="inline-flex items-center px-4 py-2 rounded font-medium text-sm border border-zinc-200 dark:border-zinc-700 hover:bg-zinc-50 dark:hover:bg-zinc-800/20 transition-colors"
              >
