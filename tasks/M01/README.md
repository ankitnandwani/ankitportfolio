...
1. **M01.01** – Initialize Repository
2. **M01.02** – Set up Next.js framework
3. **M01.03** – Configure TypeScript
4. **M01.04** – Set up linting & formatting
5. **M01.05** – Set up environment validation
6. **M01.06** – Application architecture & CI workflow
7. **M01.07** – Design token scaffold

Tasks **M01.03**, **M01.04**, and **M01.05** can be performed in parallel after **M01.02**, but the overall recommended sequence follows the list above to keep a clear progression.
